...
<?php if($_REQUEST['acao'] == "formTrabalhe_conosco"){
	if($_REQUEST['met'] == "cadastroTrabalhe_conosco"){
		...
		$trabalhe_conosco['ip'] = "";
		$trabalhe_conosco['conheceu'] = "";
      $trabalhe_conosco['mensagem'] = "";
	}else{
		...
		<form class="form" name="formTrabalhe_conosco" method="post" action="<?php echo $action; ?>" onsubmit="return verificarCampos(new Array('nome', 'email', 'telefone', 'idarea_pretendida')); return false; " enctype="multipart/form-data">
			...
			<div class="content_tit">Dados Candidato:</div>
				<div class="box_ip">
					...
					<input type="text" name="nome" id="nome" size="30" value="<?php echo $trabalhe_conosco['nome']; ?>" class='required'/>
				</div>
				<div class="box_ip">
					<label  for="email">Email</label>
					<input type="text" name="email" id="email" size="30" value="<?php echo $trabalhe_conosco['email']; ?>"  class='required'/>
				</div>
				<div class="box_ip">
					<label  for="telefone">Telefone</label>
					<input type="text" name="telefone" id="telefone" size="30" class='phone_br required' value="<?php echo $trabalhe_conosco['telefone']; ?>" />
				</div>
            ...
            <div class="box_ip" style="width: 100%;">
               <span>Mensagem</span>
               <textarea name="mensagem" id="mensagem" size="30" value="<?php echo $trabalhe_conosco['mensagem']; ?>" class='required'><?php echo $trabalhe_conosco['mensagem']; ?></textarea>
            </div>
				...
				<?php if(!empty($trabalhe_conosco['arquivo'])) 
