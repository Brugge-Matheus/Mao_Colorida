...
-- Copiando estrutura para tabela base2021.area_pretendida
...
-- Copiando dados para a tabela base2021.area_pretendida: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `area_pretendida` DISABLE KEYS */;
/*!40000 ALTER TABLE `area_pretendida` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.banner
...
-- Copiando dados para a tabela base2021.banner: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `banner` DISABLE KEYS */;
/*!40000 ALTER TABLE `banner` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.blog_categoria
...
-- Copiando dados para a tabela base2021.blog_categoria: 0 rows
/*!40000 ALTER TABLE `blog_categoria` DISABLE KEYS */;
/*!40000 ALTER TABLE `blog_categoria` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.blog_comentarios
...
-- Copiando dados para a tabela base2021.blog_comentarios: 0 rows
/*!40000 ALTER TABLE `blog_comentarios` DISABLE KEYS */;
/*!40000 ALTER TABLE `blog_comentarios` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.blog_post
...
-- Copiando dados para a tabela base2021.blog_post: 0 rows
/*!40000 ALTER TABLE `blog_post` DISABLE KEYS */;
/*!40000 ALTER TABLE `blog_post` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.blog_post_imagem
...
-- Copiando dados para a tabela base2021.contatos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `contatos` DISABLE KEYS */;
/*!40000 ALTER TABLE `contatos` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.depoimento
...
-- Copiando dados para a tabela base2021.depoimento: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `depoimento` DISABLE KEYS */;
/*!40000 ALTER TABLE `depoimento` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.diferenciais
...
-- Copiando dados para a tabela base2021.diferenciais: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `diferenciais` DISABLE KEYS */;
/*!40000 ALTER TABLE `diferenciais` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.equipe
...
-- Copiando dados para a tabela base2021.equipe: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `equipe` DISABLE KEYS */;
/*!40000 ALTER TABLE `equipe` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.faq
...
-- Copiando dados para a tabela base2021.faq: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `faq` DISABLE KEYS */;
/*!40000 ALTER TABLE `faq` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.features
...
-- Copiando dados para a tabela base2021.features: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `features` DISABLE KEYS */;
/*!40000 ALTER TABLE `features` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.galeria
...
-- Copiando dados para a tabela base2021.galeria: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `galeria` DISABLE KEYS */;
REPLACE INTO `galeria` (`idgaleria`, `nome`, `status`) VALUES
	(1, 'Galeria 1', 'A');
/*!40000 ALTER TABLE `galeria` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.galeria_imagem
...
-- Copiando dados para a tabela base2021.galeria_imagem: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `galeria_imagem` DISABLE KEYS */;
/*!40000 ALTER TABLE `galeria_imagem` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.idiomas
...
-- Copiando dados para a tabela base2021.idiomas: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `idiomas` DISABLE KEYS */;
/*!40000 ALTER TABLE `idiomas` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.idiomas_traducao
...
-- Copiando dados para a tabela base2021.idiomas_traducao: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `idiomas_traducao` DISABLE KEYS */;
/*!40000 ALTER TABLE `idiomas_traducao` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.idiomas_traducao_meses
...
-- Copiando dados para a tabela base2021.idiomas_traducao_meses: ~36 rows (aproximadamente)
/*!40000 ALTER TABLE `idiomas_traducao_meses` DISABLE KEYS */;
REPLACE INTO `idiomas_traducao_meses` (`ididiomas_traducao_meses`, `ididiomas`, `tag`, `texto`) VALUES
	(2, 1, 'January', 'Janeiro'),
...
-- -- Copiando estrutura para tabela base2021.integracoes
...
-- -- Copiando dados para a tabela base2021.integracoes: ~0 rows (aproximadamente)
-- /*!40000 ALTER TABLE `integracoes` DISABLE KEYS */;
-- /*!40000 ALTER TABLE `integracoes` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.log
...
-- Copiando dados para a tabela base2021.log: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `log` DISABLE KEYS */;
/*!40000 ALTER TABLE `log` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.logs_acessos
...
-- Copiando dados para a tabela base2021.logs_acessos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `logs_acessos` DISABLE KEYS */;
/*!40000 ALTER TABLE `logs_acessos` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.log_acessos
...
-- Copiando dados para a tabela base2021.log_acessos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `log_acessos` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_acessos` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.newsletter
...
-- Copiando dados para a tabela base2021.newsletter: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `newsletter` DISABLE KEYS */;
/*!40000 ALTER TABLE `newsletter` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.parceiros
...
-- Copiando dados para a tabela base2021.parceiros: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `parceiros` DISABLE KEYS */;
/*!40000 ALTER TABLE `parceiros` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.permissoes
...
-- Copiando dados para a tabela base2021.permissoes: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `permissoes` DISABLE KEYS */;
REPLACE INTO `permissoes` (`idpermissao`, `apelido`, `tags`) VALUES
...
-- Copiando estrutura para tabela base2021.recursos
...
-- Copiando dados para a tabela base2021.recursos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `recursos` DISABLE KEYS */;
/*!40000 ALTER TABLE `recursos` ENABLE KEYS */;

-- -- Copiando estrutura para tabela base2021.seo
...
-- -- Copiando dados para a tabela base2021.seo: ~0 rows (aproximadamente)
-- /*!40000 ALTER TABLE `seo` DISABLE KEYS */;
-- REPLACE INTO `seo` (`idseo`, `title`, `description`, `keywords`, `urlrewrite`) VALUES
-- 	(1, 'Home', 'HomeHomeHome', 'HomeHomeHomeHomeHome', 'home');
-- /*!40000 ALTER TABLE `seo` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.servicos
...
-- Copiando dados para a tabela base2021.servicos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `servicos` DISABLE KEYS */;
/*!40000 ALTER TABLE `servicos` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.timeline
...
-- Copiando dados para a tabela base2021.timeline: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `timeline` DISABLE KEYS */;
/*!40000 ALTER TABLE `timeline` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.trabalhe_conosco
...
-- Copiando dados para a tabela base2021.trabalhe_conosco: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `trabalhe_conosco` DISABLE KEYS */;
/*!40000 ALTER TABLE `trabalhe_conosco` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.usuario
...
-- Copiando dados para a tabela base2021.usuario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
REPLACE INTO `usuario` (`idusuario`, `nome`, `sobrenome`, `usuario`, `senha`, `email`, `foto`, `ultimaacao`, `proximotime`, `permissoes`, `status`, `expiracao`) VALUES
	(1, 'suporte', 'red', 'suporte.red', _binary 0xA7B15BCF8F1466DA6212410B9BDC23AA, 'atendimento@agencia.red', '5741b893a31602e948484ba5c6564be3.png', '2021-08-20 19:13:00', '2021-08-20 19:18:00', 'banner_criar banner_editar banner_visualizar banner_deletar blog_categoria_criar blog_categoria_editar blog_categoria_visualizar blog_categoria_deletar blog_comentarios_criar blog_comentarios_editar blog_comentarios_visualizar blog_comentarios_deletar blog_post_criar blog_post_editar blog_post_visualizar blog_post_deletar cases_criar cases_editar cases_visualizar cases_deletar cases_sucesso_criar cases_sucesso_editar cases_sucesso_visualizar cases_sucesso_deletar cases_tipo_criar cases_tipo_editar cases_tipo_visualizar cases_tipo_deletar contatos_criar contatos_editar contatos_visualizar contatos_deletar depoimento_criar depoimento_editar depoimento_visualizar depoimento_deletar features_criar features_editar features_visualizar features_deletar galeria_criar galeria_editar galeria_visualizar galeria_deletar log_criar log_editar log_visualizar log_deletar newsletter_criar newsletter_editar newsletter_visualizar newsletter_deletar parceiros_criar parceiros_editar parceiros_visualizar parceiros_deletar permissao_criar permissao_editar permissao_visualizar permissao_deletar servicos_criar servicos_editar servicos_visualizar servicos_deletar usuario_criar usuario_editar usuario_visualizar usuario_deletar configuracoes_listagem_usuarios configuracoes_cadastro_usuarios configuracoes_permissao configuracoes_log', '1', NULL);
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;

-- Copiando estrutura para tabela base2021.usuario_acesso
...
-- Copiando dados para a tabela base2021.usuario_acesso: ~0 rows (aproximadamente)
