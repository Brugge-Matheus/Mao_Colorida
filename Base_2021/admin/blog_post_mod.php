				...
				<div class="content_tit">Dados Blog Post:</div>
                    ...
                    <div class="box_cr box_cr_area_pretendida">
                        ...
                        <?php foreach($blog_tags as $key => $bt):?>
                            <label>
                                <input name="tags[]" value="<?=$bt['idblog_tags']?>" type="checkbox" <?=in_array($bt['idblog_tags'], $arrTags)?'checked':''?>>
                                <span><?=$bt['titulo']?></span>
                            </label>
                        <?php endforeach;?>
                    </div>
                    ...
                    <div class="box_ip box_txt pd-left-important">
                        <div class="box_ip box_txt">
							...
							<div class="content_tit" style="margin-left:0; padding-left:5px;">SEO</div>

								<div class="box_ip box_txt">
									<label for="title">Seo Title</label>
									<input type="text" name="title" id="title" size="30" maxlength="255" value="<?php echo $blog_post['title']; ?>" class=''/>
								</div>
								<div class="box_ip box_txt">
									<label for="keywords">Seo Keywords</label>
									<input type="text" name="keywords" id="keywords" size="30" maxlength="255" value="<?php echo $blog_post['keywords']; ?>" class=''/>
								</div>
								<div class="box_ip box_txt">
									<label for="description">Seo Description</label> 
									<textarea name="description" id="description" class=''><?= $blog_post['description']; ?></textarea>
								</div>
