<?php @ob_start();
	...
	if($testa == "/home/admin/web/in.agencia.red/public_html/_padroes/Base_2021"){
        @define('ENDERECO', 'http://'.$_SERVER['HTTP_HOST'].'/_padroes/Base_2021/');
    }elseif($testa == "C:\\xampp\htdocs\_padroes/Base_2021.com.br"){
        @define('ENDERECO', 'http://'.$_SERVER['HTTP_HOST'].'/_padroes/Base_2021.com.br/');
    }elseif($testa == "/home3/web/public_html/_padroes/Base_2021"){
        @define('ENDERECO', 'https://'.$_SERVER['HTTP_HOST'].'/_padroes/Base_2021/');
    }else{
