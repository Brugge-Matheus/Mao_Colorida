<?php @ob_start();
	...
	if($testa == "/home/admin/web/in.agencia.red/public_html/roadmotors"){
        @define('ENDERECO', 'http://'.$_SERVER['HTTP_HOST'].'/roadmotors/');
    }elseif($testa == "C:\\xampp\htdocs\roadmotors.com.br"){
        @define('ENDERECO', 'http://'.$_SERVER['HTTP_HOST'].'/roadmotors.com.br/');
    }elseif($testa == "/home3/web/public_html/roadmotors"){
        @define('ENDERECO', 'https://'.$_SERVER['HTTP_HOST'].'/roadmotors/');
    }else{
