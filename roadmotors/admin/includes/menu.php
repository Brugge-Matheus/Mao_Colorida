<aside class="menu bg <?=(!isset($_SESSION['lateral']) ? "open" : $_SESSION['lateral'] );?>">
  ...
  <ul class="menu_ul">
   ...
   <?php if (verificaPermissaoAcesso('diferenciais_visualizar', $MODULOACESSO['usuario'])) { ?>
      <li class="menu_ul_li">
         <a class="menu_ul_li_a"><i class='fa-icon fas fa-briefcase' aria-hidden="true"></i>Diferenciais</a>
         <ul>
            <li class="li-title-mobile">Diferenciais</li>
            <li><a href="index.php?mod=diferenciais&amp;acao=listarDiferenciais">• Consulta</a></li>
            <?php if(verificaPermissaoAcesso('diferenciais_criar', $MODULOACESSO['usuario'])): ?>
               <li><a href="index.php?mod=diferenciais&amp;acao=formDiferenciais&amp;met=cadastroDiferenciais">• Cadastro</a></li>
            <?php endif;?>
         </ul>
      </li>
   <?php } ?>

   <?php if (verificaPermissaoAcesso('valor_visualizar', $MODULOACESSO['usuario'])) { ?>
      <li class="menu_ul_li">
         <a class="menu_ul_li_a"><i class='fa-icon fas fa-wrench' aria-hidden="true"></i>Valor</a>
         <ul>
            <li class="li-title-mobile">Valor</li>
            <li><a href="index.php?mod=valor&amp;acao=listarValor">• Consulta</a></li>
         </ul>
      </li>
   <?php } ?>

   <?php if (verificaPermissaoAcesso('valores_visualizar', $MODULOACESSO['usuario'])) { ?>
      <li class="menu_ul_li">
         <a class="menu_ul_li_a"><i class='fa-icon fas fa-briefcase' aria-hidden="true"></i>Valores</a>
         <ul>
            <li class="li-title-mobile">Valores</li>
            <li><a href="index.php?mod=valores&amp;acao=listarValores">• Consulta</a></li>
            <?php if(verificaPermissaoAcesso('valores_criar', $MODULOACESSO['usuario'])): ?>
               <li><a href="index.php?mod=valores&amp;acao=formValores&amp;met=cadastroValores">• Cadastro</a></li>
            <?php endif;?>
         </ul>
      </li>
   <?php } ?>

   <?php if (verificaPermissaoAcesso('servicos_visualizar', $MODULOACESSO['usuario'])) { ?>
      <li class="menu_ul_li">
         <a class="menu_ul_li_a"><i class='fa-icon fas fa-wrench' aria-hidden="true"></i>Serviços</a>
         <ul>
            <li class="li-title-mobile">Serviços</li>
            <li><a href="index.php?mod=servicos&amp;acao=listarServicos">• Consulta</a></li>
            <?php if(verificaPermissaoAcesso('servicos_criar', $MODULOACESSO['usuario'])): ?>
               <li><a href="index.php?mod=servicos&amp;acao=formServicos&amp;met=cadastroServicos">• Cadastro</a></li>
            <?php endif;?>
         </ul>
      </li>
   <?php } ?>
